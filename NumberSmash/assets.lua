...
SfxFlipcard = sound{ "sounds/flipcard.raw" }
SfxSuccess = sound{ "sounds/success.raw" }
SfxButtonBeep = sound{ "sounds/buttonbeep.raw" }
SfxDice = sound{ "sounds/dice.raw" }
...
BGLightBlue = image{"background/lightBlue.PNG", quality = 9.99}
